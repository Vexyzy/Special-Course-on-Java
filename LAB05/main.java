...
import RunnableThreads.ReadRunnableThread;
import RunnableThreads.Synchronizer;
import RunnableThreads.WriteRunnableThread;
...
class Main
{
    ...
    public static void firstThreadTask()
    {
        DigitsImpl digitOfArticle = new DigitsOfArticle();

        WriteThread firstThread = new WriteThread(digitOfArticle);
        ReadThread secondThread = new ReadThread(digitOfArticle);
        
        firstThread.start();
        secondThread.start();
    }

    public static void secondThreadTask()
    {
        DigitsImpl digitOfArticle = new DigitsOfArticle();
        Synchronizer synchronizer = new Synchronizer(digitOfArticle);

        Thread firstThread = new Thread(new WriteRunnableThread(synchronizer));
        Thread secondThread = new Thread(new ReadRunnableThread(synchronizer));

        firstThread.start();
        secondThread.start();
    }

    public static void thirdThreadTask()
    {
        DigitsImpl digitOfArticle = new DigitsOfArticle();
        Synchronizer synchronizer = new Synchronizer(DigitsArrWR.synchronize(digitOfArticle));
